...
public class GoogleTaskApi implements TaskApi {
    private static final String TAG = GoogleTaskApi.class.getSimpleName();
    ...
    public GoogleTaskApi(String authToken) {
        Log.d(GoogleTaskApi.class.getSimpleName(), "token--" + authToken);
...
//                request.addHeader("User-Agent", " Mozilla/5.0 (Windows NT 5.1; rv:19.0) Gecko/20100101 Firefox/19.0");
            }
        };
